...
/**
 * CorpusItem is the thrift equivalent of http://trec-kba.org/schemas/v1.0/corpus-item.json
 */
public class CorpusItem implements org.apache.thrift.TBase<CorpusItem, CorpusItem._Fields>, java.io.Serializable,
		Cloneable {
	...
	public CorpusItem(String doc_id, ByteBuffer abs_url, String schost, ByteBuffer original_url, String source,
			ContentItem title, ContentItem body, ContentItem anchor, ByteBuffer source_metadata) {
		this();
		this.doc_id = doc_id;
	...
	private static class CorpusItemStandardScheme extends StandardScheme<CorpusItem> {
		...
		@Override
		public void write(org.apache.thrift.protocol.TProtocol oprot, CorpusItem struct)
