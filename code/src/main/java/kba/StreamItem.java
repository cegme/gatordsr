...
/**
 * This is the primary interface to the data. StreamItem is the thrift equivalent of
 * http://trec-kba.org/schemas/v1.0/stream-item.json
 * 
 * which extends corpus-item.json. For better or worse, thrift does not support inheritence on
 * struct, so this copies the first nine fields of CorpusItem and then adds two more fields.
 */
public class StreamItem implements org.apache.thrift.TBase<StreamItem, StreamItem._Fields>, java.io.Serializable,
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		DOC_ID((short) 1, "doc_id"), ABS_URL((short) 2, "abs_url"), SCHOST((short) 3, "schost"), ORIGINAL_URL((short) 4,
				"original_url"), SOURCE((short) 5, "source"), TITLE((short) 6, "title"), BODY((short) 7, "body"), ANCHOR(
				(short) 8, "anchor"), SOURCE_METADATA((short) 9, "source_metadata"), STREAM_ID((short) 10, "stream_id"), STREAM_TIME(
				(short) 11, "stream_time");
	...
	static {
		...
		tmpMap.put(_Fields.BODY, new org.apache.thrift.meta_data.FieldMetaData("body",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
						org.apache.thrift.protocol.TType.STRUCT, ContentItem.class)));
		tmpMap.put(_Fields.ANCHOR, new org.apache.thrift.meta_data.FieldMetaData("anchor",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
						org.apache.thrift.protocol.TType.STRUCT, ContentItem.class)));
	...
	public StreamItem(String doc_id, ByteBuffer abs_url, String schost, ByteBuffer original_url, String source,
			ContentItem title, ContentItem body, ContentItem anchor, ByteBuffer source_metadata, String stream_id,
