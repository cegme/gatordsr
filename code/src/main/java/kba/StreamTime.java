...
/**
 * StreamTime is a timestamp measured in seconds since the 1970 epoch. 'news', 'linking', and
 * 'social' each have slightly different ways of generating these timestamps. See details:
