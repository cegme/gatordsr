...
public class Sentence implements org.apache.thrift.TBase<Sentence, Sentence._Fields>, java.io.Serializable, Cloneable,
	...
	private static final org.apache.thrift.protocol.TField						TOKENS_FIELD_DESC	= new org.apache.thrift.protocol.TField(
																																													"tokens",
	...
	/**
	 * array of instances of Label attached to this sentence, defaults to an empty map
	 */
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.TOKENS, new org.apache.thrift.meta_data.FieldMetaData("tokens",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.ListMetaData(
						org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.StructMetaData(
								org.apache.thrift.protocol.TType.STRUCT, Token.class))));
	...
	private static class SentenceTupleScheme extends TupleScheme<Sentence> {
		...
		public void read(org.apache.thrift.protocol.TProtocol prot, Sentence struct) throws org.apache.thrift.TException {
			...
			if (incoming.get(0)) {
				{
					org.apache.thrift.protocol.TList _list54 = new org.apache.thrift.protocol.TList(
			...
			if (incoming.get(1)) {
				{
					org.apache.thrift.protocol.TMap _map57 = new org.apache.thrift.protocol.TMap(
