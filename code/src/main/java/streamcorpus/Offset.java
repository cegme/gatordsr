...
public class Offset implements org.apache.thrift.TBase<Offset, Offset._Fields>, java.io.Serializable, Cloneable,
	...
	private static final org.apache.thrift.protocol.TField						TYPE_FIELD_DESC					= new org.apache.thrift.protocol.TField(
																																																...
																																																(short) 1);
	private static final org.apache.thrift.protocol.TField						FIRST_FIELD_DESC				= new org.apache.thrift.protocol.TField(
																																																"first",
	...
	private static final org.apache.thrift.protocol.TField						LENGTH_FIELD_DESC				= new org.apache.thrift.protocol.TField(
																																																...
																																																org.apache.thrift.protocol.TType.I32,
																																																(short) 3);
	private static final org.apache.thrift.protocol.TField						XPATH_FIELD_DESC				= new org.apache.thrift.protocol.TField(
																																																"xpath",
																																																org.apache.thrift.protocol.TType.STRING,
																																																(short) 4);
	private static final org.apache.thrift.protocol.TField						CONTENT_FORM_FIELD_DESC	= new org.apache.thrift.protocol.TField(
																																																"content_form",
																																																org.apache.thrift.protocol.TType.STRING,
																																																(short) 5);
	...
	/**
	 * actual offset, which could be measured in bytes, chars, or lines. The data element identified
	 * by 'first' is included, and that identified by first+length is also included.
	 * 
	 * In set notation, [first:first+length]
	 * 
	 * or equivalently [first:first+length+1)
	 * 
	 * While thrift treats these as signed integers, negative values are meaningless in this context,
	 * i.e. we do not end wrap.
	 */
	public long																												first;																																						// required
	public int																												length;																																					// required
	/**
	 * if xpath is not empty, then annotation applies to an offset within data that starts with an
	 * XPATH query into XHTML or XML
	 */
	public String																											xpath;																																						// optional
	/**
	 * name of the data element inside a ContentItem to which this label applies, e.g. 'raw'
	 * 'clean_html' or 'clean_visible'. Defaults to clean_visible, which is the most common case.
	 */
	public String																											content_form;																																		// optional
	/**
	 * bytes specified by this offset extracted from the original; just to assist in debugging
	 */
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		 ...
		 * or equivalently [first:first+length+1)
		 * 
		 * While thrift treats these as signed integers, negative values are meaningless in this
		 * context, i.e. we do not end wrap.
		 */
		FIRST((short) 2, "first"), LENGTH((short) 3, "length"),
		/**
		 * if xpath is not empty, then annotation applies to an offset within data that starts with an
		 * XPATH query into XHTML or XML
		 */
	...
	private _Fields																															optionals[]				= { _Fields.XPATH,
			_Fields.CONTENT_FORM, _Fields.VALUE																											};
	...
	static {
		...
		tmpMap.put(_Fields.FIRST, new org.apache.thrift.meta_data.FieldMetaData("first",
		...
		tmpMap.put(_Fields.LENGTH, new org.apache.thrift.meta_data.FieldMetaData("length",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.I32)));
		tmpMap.put(_Fields.XPATH, new org.apache.thrift.meta_data.FieldMetaData("xpath",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.CONTENT_FORM, new org.apache.thrift.meta_data.FieldMetaData("content_form",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
	...
	public Offset(OffsetType type, long first, int length) {
		this();
		this.type = type;
		this.first = first;
		setFirstIsSet(true);
