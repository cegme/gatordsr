...
/**
 * StreamTime is a timestamp measured in seconds since the 1970 epoch. epoch_ticks is always in the
 * UTC timezone. This is used in several structs below to record various moments in history.
 * 
 * Implementations of these interfaces in various languages may provide convenience methods for
 * insuring that these two fields are consistent with each other.
 */
public class StreamTime implements org.apache.thrift.TBase<StreamTime, StreamTime._Fields>, java.io.Serializable,
		Cloneable, Comparable<StreamTime> {
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		EPOCH_TICKS((short) 1, "epoch_ticks"), ZULU_TIMESTAMP((short) 2, "zulu_timestamp");
	...
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.EPOCH_TICKS, new org.apache.thrift.meta_data.FieldMetaData("epoch_ticks",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.DOUBLE)));
		tmpMap.put(_Fields.ZULU_TIMESTAMP, new org.apache.thrift.meta_data.FieldMetaData("zulu_timestamp",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
	...
	private static class StreamTimeStandardScheme extends StandardScheme<StreamTime> {
		...
		@Override
		public void write(org.apache.thrift.protocol.TProtocol oprot, StreamTime struct)
