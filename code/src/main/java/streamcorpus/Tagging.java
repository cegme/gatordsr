...
public class Tagging implements org.apache.thrift.TBase<Tagging, Tagging._Fields>, java.io.Serializable, Cloneable,
	...
	private static final org.apache.thrift.protocol.TField						TAGGER_ID_FIELD_DESC				= new org.apache.thrift.protocol.TField(
																																																		"tagger_id",
																																																		org.apache.thrift.protocol.TType.STRING,
																																																		(short) 1);
	private static final org.apache.thrift.protocol.TField						RAW_TAGGING_FIELD_DESC			= new org.apache.thrift.protocol.TField(
																																																		"raw_tagging",
																																																		org.apache.thrift.protocol.TType.STRING,
																																																		(short) 2);
	private static final org.apache.thrift.protocol.TField						TAGGER_CONFIG_FIELD_DESC		= new org.apache.thrift.protocol.TField(
																																																		"tagger_config",
																																																		org.apache.thrift.protocol.TType.STRING,
																																																		(short) 3);
	private static final org.apache.thrift.protocol.TField						TAGGER_VERSION_FIELD_DESC		= new org.apache.thrift.protocol.TField(
																																																		"tagger_version",
																																																		org.apache.thrift.protocol.TType.STRING,
																																																		(short) 4);
	private static final org.apache.thrift.protocol.TField						GENERATION_TIME_FIELD_DESC	= new org.apache.thrift.protocol.TField(
																																																		"generation_time",
	...
	private _Fields																															optionals[]	= { _Fields.TAGGER_CONFIG,
			_Fields.TAGGER_VERSION, _Fields.GENERATION_TIME																		};
	public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData>	metaDataMap;
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.TAGGER_ID, new org.apache.thrift.meta_data.FieldMetaData("tagger_id",
		...
		tmpMap.put(_Fields.RAW_TAGGING, new org.apache.thrift.meta_data.FieldMetaData("raw_tagging",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING, true)));
		tmpMap.put(_Fields.TAGGER_CONFIG, new org.apache.thrift.meta_data.FieldMetaData("tagger_config",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.TAGGER_VERSION, new org.apache.thrift.meta_data.FieldMetaData("tagger_version",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.GENERATION_TIME, new org.apache.thrift.meta_data.FieldMetaData("generation_time",
	...
	public Tagging(String tagger_id, ByteBuffer raw_tagging) {
		this();
