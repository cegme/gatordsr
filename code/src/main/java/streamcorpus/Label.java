...
/**
 * Labels are human generated assertions about a portion of a document For example, a human author
 * might label their own text by inserting hyperlinks to Wikipedia, or a NIST assessor might record
 * which tokens in a text mention a target entity.
 * 
 * Label instances can be attached in three palces: - Token.labels list - Sentence.labels list -
...
public class Label implements org.apache.thrift.TBase<Label, Label._Fields>, java.io.Serializable, Cloneable,
	...
	/**
	 * pointers to data to which this label applies. If empty, then label applies to the entire Token,
	 * Sentence, or ContentItem to which it is attached.
	 */
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		...
		/**
		 * pointers to data to which this label applies. If empty, then label applies to the entire
		 * Token, Sentence, or ContentItem to which it is attached.
		 */
	...
	public Label(Annotator annotator, Target target) {
		this();
