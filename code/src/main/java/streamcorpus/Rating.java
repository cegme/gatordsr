...
/**
 * Ratings are buman generated assertions about a entire document's utility for a particular topic
 * or entity in a reference KB.
 */
public class Rating implements org.apache.thrift.TBase<Rating, Rating._Fields>, java.io.Serializable, Cloneable,
	...
	private static final org.apache.thrift.protocol.TField						ANNOTATOR_FIELD_DESC				= new org.apache.thrift.protocol.TField(
																																																		"annotator",
	...
	private static final org.apache.thrift.protocol.TField						TARGET_FIELD_DESC						= new org.apache.thrift.protocol.TField(
																																																		...
																																																		org.apache.thrift.protocol.TType.STRUCT,
																																																		(short) 2);
	private static final org.apache.thrift.protocol.TField						RELEVANCE_FIELD_DESC				= new org.apache.thrift.protocol.TField(
																																																		"relevance",
																																																		org.apache.thrift.protocol.TType.I16,
																																																		(short) 3);
	private static final org.apache.thrift.protocol.TField						CONTAINS_MENTION_FIELD_DESC	= new org.apache.thrift.protocol.TField(
																																																		"contains_mention",
	...
	private static final org.apache.thrift.protocol.TField						COMMENTS_FIELD_DESC					= new org.apache.thrift.protocol.TField(
																																																		...
																																																		(short) 5);
	private static final org.apache.thrift.protocol.TField						MENTIONS_FIELD_DESC					= new org.apache.thrift.protocol.TField(
																																																		"mentions",
	...
	/**
	 * numerical score assigned by annotator to "judge" or "rate" the utility of this StreamItem to
	 * addressing the target information need. The range and interpretation of relevance numbers
	 * depends on the annotator. relevance can represent a rank ordering or an enumeration such as
	 * -1=Garbage, 0=Neutral, 1=Useful, 2=Vital
	 */
	public short																											relevance;																																						// optional
	/**
	 * true|false indication of whether the document mentions the target entity. This is only
	 * partially correlated with relevance. For example, a document might mention the entity only in
	 * chrome text on the side such that it is a Garbage-rated text for that entity.
	 */
	...
	private _Fields																															optionals[]									= {
			_Fields.RELEVANCE, _Fields.CONTAINS_MENTION, _Fields.COMMENTS, _Fields.MENTIONS										};
	public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData>	metaDataMap;
	static {
		Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
				_Fields.class);
		tmpMap.put(_Fields.ANNOTATOR, new org.apache.thrift.meta_data.FieldMetaData("annotator",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
						org.apache.thrift.protocol.TType.STRUCT, Annotator.class)));
		tmpMap.put(_Fields.TARGET, new org.apache.thrift.meta_data.FieldMetaData("target",
				org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
						org.apache.thrift.protocol.TType.STRUCT, Target.class)));
		tmpMap.put(_Fields.RELEVANCE, new org.apache.thrift.meta_data.FieldMetaData("relevance",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.I16)));
		tmpMap.put(_Fields.CONTAINS_MENTION, new org.apache.thrift.meta_data.FieldMetaData("contains_mention",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.BOOL)));
		tmpMap.put(_Fields.COMMENTS, new org.apache.thrift.meta_data.FieldMetaData("comments",
				org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.MENTIONS, new org.apache.thrift.meta_data.FieldMetaData("mentions",
	...
	public Rating(Annotator annotator, Target target) {
		this();
	...
	private static class RatingTupleScheme extends TupleScheme<Rating> {
		...
		public void read(org.apache.thrift.protocol.TProtocol prot, Rating struct) throws org.apache.thrift.TException {
			...
			if (incoming.get(5)) {
				{
					org.apache.thrift.protocol.TList _list133 = new org.apache.thrift.protocol.TList(
