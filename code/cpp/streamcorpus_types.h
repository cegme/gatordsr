...
typedef struct _ContentItem__isset {
  _ContentItem__isset() : raw(false), encoding(false), media_type(false), clean_html(false), clean_visible(false), logs(true), taggings(true), labels(true), sentences(true), sentence_blobs(true), language(false) {}
  bool raw;
  bool encoding;
  bool media_type;
  bool clean_html;
...
class ContentItem {
 public:
  ...
  static const char* ascii_fingerprint; // = "487BE901B62B179EF8670F84FF3EA177";
  static const uint8_t binary_fingerprint[16]; // = {0x48,0x7B,0xE9,0x01,0xB6,0x2B,0x17,0x9E,0xF8,0x67,0x0F,0x84,0xFF,0x3E,0xA1,0x77};
...
class StreamItem {
 public:
  ...
  static const char* ascii_fingerprint; // = "F0D6A9AADC4FBB1DC66080270058F371";
  static const uint8_t binary_fingerprint[16]; // = {0xF0,0xD6,0xA9,0xAA,0xDC,0x4F,0xBB,0x1D,0xC6,0x60,0x80,0x27,0x00,0x58,0xF3,0x71};
