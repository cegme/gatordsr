...
entities as query nodes \cite{mcnamee2012hltcoe,dalton2013bi,Bonnefoy:2013:WDE:2484028.2484180,Balog:2013:CCR:2484028.2484151,ji2011knowledge} 
%,\cite{balog2013cumulative}
.
...
\begin{figure}
  \centering
  %\includegraphics{./images/sr.pdf}
  \includegraphics{./images/s_cropped_preview.jpg} % created using adjust size in Mac Preview app.
...
\begin{figure}
\centering
\includegraphics{./images/pattern-crop_2.jpg}
...
Christan Grant is funded by a National Science Foundation Graduate Research Fellowship under Grant No. DGE-0802270. This work has also been supported in part by DARPA under
