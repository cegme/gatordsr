...
Entities can have different coverages across the entire web, some are more popular such as William H. Gates or less well known such as Stevens Cooperative School; similarly slot names have various coverages e.g. being an \textit{Affiliate} is much more probable across the entities vs \textit{AwardsWon}. %\ceg{(define `entity coverage' here)}
