...
We our methods produced an accuracies of  54\% and 55\%.
...
Using our methods, we provide we provide more detailed statistics, as displayed in Table~\ref{table:finalresultrecall} and Table~\ref{table:finalresultaccuracy}.
Table~\ref{table:finalresultrecall} shows the recall for each slot name. \ceg{(define `entity coverage' here)}
...
Affiliate is a generic slot name, using patterns to extract these relationships is difficult because almost any
