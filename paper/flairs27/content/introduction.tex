...
In this paper we develop an efficient query-driven slot extraction for given WP entities from a time oriented document stream.
...
\textit{DateOfDeath} with a slot valye of \text{March 2013}.
